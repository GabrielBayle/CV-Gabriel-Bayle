...
%-------------------------------------------------------------------------------
\name{Gabriel Bayle}{}
\position{PhD{\enskip\cdotp\enskip}Behavioral and Experimental Economics}
\address{GATE LSE - UMR5824 - CNRS, Université Lumière-Lyon 2, Université Jean-Monnet-St-Etienne, emlyon}

%\mobile{+1 000-000-0000}
\email{gabriel.bayle.econ@gmail.com}
\homepage{https://sites.google.com/view/gabrielbayle}
\github{GabrielBayle}
%\linkedin{mylinkedin}
% \gitlab{my-gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@gabrielbayle.bsky.social}
% \reddit{reddit-id}
\extrainfo{@gabrielbayle.bsky.social}
...
\makecvfooter
  {February 2024}
  {Gabriel Bayle ~~~·~~~ Curriculum Vitae}
  {\thepage}
